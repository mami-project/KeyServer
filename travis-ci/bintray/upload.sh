...
then
    ...
    curl -v -T ./target/bintray/KeyServer-*.jar -ujgm1986:$BINTRAY_API_KEY -H "X-Bintray-Package:KeyServer-DEV" -H "X-Bintray-Version:$TRAVIS_TAG" -H "X-Bintray-Publish:1" -H "X-Bintray-Override:1" https://api.bintray.com/content/jgm1986/KeyServer/KeyServer/$TRAVIS_TAG/
fi
